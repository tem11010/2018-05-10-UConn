...
instructor: ["Timothy Moore", "James Mickley", "Pariksheet Nanda"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Henry Frye", "Wanli Xu", "Charlie Brown", "Austin Spence", "Kendra Maas"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["timothy.e.moore@uconn.edu", "james.mickley@uconn.edu", "pariksheet.nanda@uconn.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
...
eventbrite:     "44981464772"      # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
      	  ...
      	  <ol>
      	    <li>For Ubuntu and derivatives, run the following in a terminal:
      	      <ol>
      	        ...
      	        <code>sudo add-apt-repository -y ppa:linuxgndu/sqlitebrowser</code></li>
      	        <li>Update the cache: <br/>
      	        <code>sudo apt-get update</code></li>
      	        <li>Install package: <br/>
      	        <code>sudo apt-get install sqlitebrowser</code></li>
      	      </ol>
      	    </li>
